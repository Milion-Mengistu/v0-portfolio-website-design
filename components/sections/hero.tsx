        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-balance">
              <span className="text-foreground">Milion Mengistu</span>
              <br />
            ...
            {/* Typing tagline */}
            <div className="h-12 md:h-16 mb-8 flex items-center justify-center md:justify-start">
              <p className="text-lg md:text-xl text-muted-foreground text-balance font-light">
                {displayText}
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a
                href="https://github.com/Milion-Mengistu"
                target="_blank"
